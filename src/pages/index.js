...
import { FaLinkedin, FaPhoneAlt, FaGithubAlt } from "react-icons/fa";
  ...
  <Layout>
    ...
    <ColumnWrap>
      ...
      <Place time="From Sept 2020:" place="Jollywise">
        ...
        according to a new api &amp; adding new components and functionality. CI
        with github &amp; Jenkins. Returned for a quick client christmas card
        quiz microsite, and again for a React microsite with several simple JS
        minigames.
      </Place>
      ...
      <Place time="Feb - Mar 2020:" place="EDD London">
        ...
        components, then leading on upgrading from a rigid desktop site to being
      ...
      <Place time="Oct 2019 - Feb 2020:" place="Rehab Agency">
        ...
        translated into 8 languages. Used React, JSON, hooks, css modules, SCORM
        &amp; Sketch. Mentored other devs to bring parallel projects up to
        speed.
      </Place>
      ...
      <Place time="May and Sept-Oct 2018:" place="22 design">
        ...
        prototyping a JS 360 spinner, updating an Opencart website and building
        a interactive quiz module.
      </Place>
      <Place time="May to Sept 2018:" place="KoffeeCup">
        ...
        tight turnarounds. Returned to lay the groundwork for a Red Bull project
        that unfortunately never left the ground.
      </Place>
      <Place time="Jul 2015 to Dec 2017: Front end Contractor" place="YunoJuno">
        Rapid prototyping &amp; building of a constantly evolving UX &amp; Front
        end, taming sprawling legacy CSS &amp; maintaining an extensive design
        system using practical BEM, Stylus/SASS, Django templating &amp; later
        React. A highlight was a complete site redesign using only a CSS
        retheme.
      </Place>
      <Place
        ...
        place="MetaBroadcast"
      >
        Joining a software engineering team this was my first JavaScript-centric
        role, prototyping UIs for metadata API tools for the BBC. I also
        contributed to the company blog &amp; spoke at monthly meetups.
      </Place>
      <Place
      ...
      >
        ...
        jQ for integration to Umbraco. Following projects included Cameraworks,
        Rex &amp; Mariano, Eris Industries, Heineken, DMB Represents, &amp;
        Blossom Hill.
      </Place>
      ...
      <NoColWrap>
        ...
        >
          ...
          site that got 500k uniques a day &amp; 3mil in revenue a week. Interim
          front end lead then focused to CSS &amp; UX as the team upscaled from
          6 devs to 20.
          <br /> I also organised knowledge-sharing workshops, was on the social
      ...
      >
        ...
        between the tech &amp; creative departments, &amp; presented on company
      ...
      <div class="Appendix-skills">
        ...
        <Skill title="Scripting">
          ...
          React Native, previously worked with Angular 2, PHP &amp; a variety of
          back ends.
        </Skill>
        <Skill title="Markup">
        ...
        <Skill title="Styling">
          ...
          modularity, nearer SMACSS-based architecture, now js-wrapped modules,
        ...
        <Skill title="Education">BEng (Mechanical) at Warwick University</Skill>
      </div>
